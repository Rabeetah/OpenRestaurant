...
exports.creditCard =  (function(req, res, next) {
	...
	creditCard.setCardNumber(req.body.cardno);
	creditCard.setExpirationDate(req.body.expdate);
	...
	orderDetails.setInvoiceNumber(req.body.invoiceno);
	...
	//Defaults to sandbox
    if(constants.productionEnvironment == 'True'){
