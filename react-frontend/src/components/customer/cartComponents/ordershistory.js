...
class OrdersHistory extends React.Component
{
    ...
    componentDidMount = async () => {
        ...
        if(this.props.auth.isAuthenticated){
          ...
          await axios.post('http://localhost:4000/customer/order/viewallcustomerorders/complete', body, config)
            .then(res => {
            ...
            <div>
                ...
                <div>
                    ...
                    <div style={{paddingRight: '30em'}}>
                        ...
                        <Button style={{marginRight: '30%'}} className='button'><Link to={`/ordershistory/order/${order.orderid}`}>View Details</Link></Button>
                        </Card.Grid>
                        </Card>
                      <br/>
                      </div>
