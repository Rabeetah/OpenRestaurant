...
export const loadUser = () => (dispatch, getState) => {
  ...
  axios
    .get('http://localhost:4000/userprofile/customer/getcustomer', tokenConfig(getState))
    .then(res =>
      dispatch({
        type: USER_LOADED,
        payload: res.data
...
//   axios
//     .post('http://localhost:4000/userprofile/customer/registercustomer', body, config)
//     .then(res =>
//       dispatch({
